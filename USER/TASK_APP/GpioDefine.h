...
#define GPIO_GPS_EN        		 GPIOE,GPIO_Pin_10    //GPS开关；低电平使能
...
#define GPIO_CTL_DIR_S1 	 	 GPIOA,GPIO_Pin_11	  //从动轮方向1
#define GPIO_CTL_DIR_S2 	 	 GPIOA,GPIO_Pin_12	  //从动轮方向2
#define GPIO_CTL_DIR_M1 	 	 GPIOB,GPIO_Pin_8	  //主动轮方向1
#define GPIO_CTL_DIR_M2 	 	 GPIOB,GPIO_Pin_9	  //主动轮方向2
